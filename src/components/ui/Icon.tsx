...
const paths: Record<IconName, JSX.Element> = {
  ...
  whatsapp: (
    <>
      ...
      <path d="M9 9.2c.2-.6.4-.6.7-.6h.5c.2 0 .4 0 .6.5l.7 1.6c0 .2 0 .4-.1.6l-.4.5c-.2.2-.3.4-.1.7a6 6 0 0 0 2.6 2.3c.3.2.5.1.7-.1l.5-.6c.2-.2.4-.2.6-.1l1.6.8c.2.1.4.2.4.4 0 .6-.3 1.3-.6 1.5-.4.3-1.3.7-2.3.4a8 8 0 0 1-5.4-5.2c-.3-.9 0-1.7.3-2.1Z" />
    </>
  ),
  instagram: (
    <>
